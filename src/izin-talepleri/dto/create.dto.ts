import { IsString, IsNumber, IsArray, ValidateNested, IsObject, IsBoolean, IsOptional, ArrayMinSize, Min } from 'class-validator';
...
export class ItemValueDto {
  ...
  @IsNumber({}, { message: 'Toplam gün number türünde olmalıdır' })
  @Min(1,{message:'Toplam gün en az 1 olmalıdır.'})
  ToplamGun: number;
}

export class GunlerCheckedDto {
  @IsBoolean()
...
export class UpdateItemValueDto {
...
export class UpdateIzinDto {
  @IsObject()
  @ValidateNested()
  @Type(() => UpdateItemValueDto)
  itemValue: UpdateItemValueDto;

...
import { MpJwtAuthGuard } from './jwt-auth.guard';
...
export class MpAuthController {
    constructor(private readonly authService: MpAuthService) { }
    ...
    async updateUserAvatar(
        ...
        try {
            ...
            const baseDir = path.join(process.cwd(), 'public', 'uploads', 'mp', 'profile-images');
            ...
            const publicPath = `/uploads/mp/profile-images/${filename}`;
